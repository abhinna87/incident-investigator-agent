/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 30ed7cc02b519ff656a1c08bc184ec58)
// Runtime types generated with workerd@1.20260721.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ALLOW_UNSIGNED_WEBHOOKS: "true";
	IncidentAgent: DurableObjectNamespace<import("./src/server").IncidentAgent>;
	RCA_WORKFLOW: Workflow<Parameters<import("./src/server").RcaWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_UNSIGNED_WEBHOOKS">> {}
}
